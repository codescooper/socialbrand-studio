...
- [x] Validation locale complète réussie : 17 fichiers de tests, 72 tests, lint, typecheck, format, contrôles cloud/PWA et build.
...
- La couverture globale est d’environ 40 % ; les parcours critiques du backend et du CORS disposent de contrôles dédiés.

## ⏭️ Prochaine action

Effectuer le test manuel du lien magique depuis `http://127.0.0.1:1420/`, puis fusionner la PR #6 si la CI reste verte.
